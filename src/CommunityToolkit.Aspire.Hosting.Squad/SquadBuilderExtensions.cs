        ...
        resourceBuilder.WithCommand(
            ...
            executeCommand: ctx =>
            {
                if (resource.Annotations.OfType<SquadTeamAnnotation>().FirstOrDefault() is not { } annotation)
                    return Task.FromResult(new ExecuteCommandResult { Success = false, ErrorMessage = "No team annotation found." });
        ...
        resourceBuilder.WithCommand(
            ...
            executeCommand: ctx =>
            {
                ...
                return Task.FromResult(result.Success
                    ...
                    : new ExecuteCommandResult { Success = false, ErrorMessage = result.Message });
            },
            new CommandOptions
            {
